...
/**
 * StarterPricingCard Component
 * 
 * A self-contained pricing card component for the Starter plan.
...
export interface StarterPricingCardProps {
...
// Starter plan data defined directly in the component
const starterPlan: PricingPlan = {
  title: PRODUCT_IDS.starter.displayName,
  monthlyPrice: "$29",
  yearlyPrice: "$290",
  description: "Perfect for small projects and startups just getting off the ground.",
  features: [
...
// Product IDs for the Starter plan
const productIds = {
  monthly: PRODUCT_IDS.starter.monthly,
  annual: PRODUCT_IDS.starter.annual
};
